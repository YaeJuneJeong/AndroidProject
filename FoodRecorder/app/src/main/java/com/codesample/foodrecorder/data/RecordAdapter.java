...
import com.codesample.foodrecorder.RecordActivity;
...
public class RecordAdapter extends RecyclerView.Adapter<RecordAdapter.ItemViewHolder> {
    ...
    public RecordAdapter(ArrayList<FoodRecord> recordData, RecordActivity recordActivity){this.recordData=recordData;
